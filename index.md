...
# About
21/電気通信大学
現在サイト工事中です フレームワークから一新予定

## Profile:
- <span>Handle</span>:parfait9(PANAP)
- <span>Name</span>:豊田悠乃 Yuno Toyota
- <span>Address</span>:東京都
- <span>Working on</span>:プログラミング/映像制作/イラスト

# Skills
- <div class="long"><span>Programming Languages</span>:<br>Python/HTML/CSS/Scratch/JS/Arduino/C</div>
- <span>Frameworks</span>:Django/Jekyll/React/React Native/Next
